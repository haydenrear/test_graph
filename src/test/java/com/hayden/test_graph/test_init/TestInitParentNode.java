...
@Component
@ResettableThread
public class TestInitParentNode implements InitNode<TestInitParentCtx> {
    ...
    @Override
    public List<Class<? extends InitNode<TestInitParentCtx>>> dependsOn() {
        return List.of(
                TestInitParentDepNode.class
        );
    }
}
